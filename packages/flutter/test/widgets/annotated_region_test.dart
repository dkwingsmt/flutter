...
void main() {
  ...
  testWidgets('provides a value to the annotation tree in a particular region', (WidgetTester tester) async {
    ...
    HitTestEntry result = RendererBinding.instance.renderView.searchFirst<ValueTarget<int>>(const Offset(10.0, 10.0));
    expect(result, isNull);
    result = RendererBinding.instance.renderView.searchFirst<ValueTarget<int>>(const Offset(50.0, 50.0));
    expect(result, isNotNull);
    expect(result.targetAs<ValueTarget<int>>().value, 1);
  });
}
